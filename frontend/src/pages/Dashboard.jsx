...
import ZoneDensityGrid from '../components/ZoneDensityGrid.jsx';
...
const TABS = ['Alerts', 'Risk', 'Incidents', 'Forecast', 'Heatmap'];
...
export default function Dashboard() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-48px)] overflow-hidden" style={{ background: 'var(--bg)' }}>
          ...
          <div className="flex-1 overflow-hidden p-3">
            ...
            {rightTab === 'Heatmap' && (
              <div className="p-4 text-center text-sm theme-text-muted">
                Toggle the Heatmap on the Venue Map to see real-time crowd density distribution generated by CSRNet.
              </div>
            )}
          </div>
        </aside>
      ...
      <footer className="border-t px-4 py-2 shrink-0 card-sm" style={{ borderRadius: 0 }}>
